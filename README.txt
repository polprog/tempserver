Polprog's temporary server kit
==============================

This is a collection of scripts that allow you to set up a temporary DHCP, FTP
and TFTP server. The aim of this is to enable creating a fast test network on a
computer without the hassle of needing to edit system-wide configuration files
or enable/disable system services.
